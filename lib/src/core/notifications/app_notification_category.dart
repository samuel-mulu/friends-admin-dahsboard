const notificationCategoryGameStarted = 'GAME_STARTED';
const notificationCategoryBonusGameStarted = 'BONUS_GAME_STARTED';
const notificationCategoryGameFinished = 'GAME_FINISHED';
const notificationCategoryWinnerAnnouncement = 'WINNER_ANNOUNCEMENT';
const notificationCategoryRegistrationOpen = 'REGISTRATION_OPEN';
const notificationCategoryBigGameRegistrationOpen = 'BIG_GAME_REGISTRATION_OPEN';
...
const notificationCategorySystem = 'SYSTEM';

const notificationCategories = <String>{
  notificationCategoryGameStarted,
  notificationCategoryBonusGameStarted,
  notificationCategoryGameFinished,
